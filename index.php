    ...
    <head>
		...
		<meta name="viewport" content="width=device-width,user-scalable = no"/>
       	<style media="screen">
			...
			div#weather_container { float : left;width : 300px;height : 270px;}
			div#day {padding-top : 80px;font-size : 70px}
			div#temp {padding-top : 10px;font-size : 70px}
			#container ul
			{
			margin: 0;
			padding: 0;
	...
	<body>
		<div id='container'>
			<ul>
				...
				<li><div id='day'>31 juillet 2012</div><div id='temp'>18 °</div></li>
